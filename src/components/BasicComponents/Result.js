...
class Result extends Component {
    ...
    otherTestBannerRenderer() {
        ...
        let weekendScheduleList = ["weekendSchedule"];
        ...
        if(personalColor2022ListKor.includes(this.state.current_test)){
        ...
        } else if (weekendScheduleList.includes(this.state.current_test)) {
            const rederTestList = ["colorFiveTheme", "fifteenTheme", "youAndI", "blogChar", "catoonChar", "switchOnOff", "colorVideo",];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
            ...
            const rederTestList = ["colorFiveTheme", "fifteenTheme", "weekendSchedule", "youAndI", "blogChar", "catoonChar", "switchOnOff",];
            return(
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
