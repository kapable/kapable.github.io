...
class Result extends Component {
    ...
    otherTestBannerRenderer() {
        ...
        let colorRibbonList = ["colorRibbon"];
        ...
        if(personalColor2022ListKor.includes(this.state.current_test)){
        ...
        } else if (colorRibbonList.includes(this.state.current_test)) {
            ...
            const rederTestList = ["fifteenTheme", "colorRibbon", "mindFlow", "colorTheme", "dmChar",];
            return(
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
