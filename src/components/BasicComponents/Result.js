...
class Result extends Component {
    ...
    otherTestBannerRenderer() {
        ...
        let loveTicketJPList = ["loveTicketJP"];
        ...
        if(personalColor2022ListKor.includes(this.state.current_test)){
            ...
            const rederTestList = ["loveTicketJP", "labelStickerJP", "characteristicChracterJP", "loveCharacterJP", "loveWarningJP", "meGuideJP", "smileColorTestJP",];
            return(
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
        ...
        } else if (loveTicketJPList.includes(this.state.current_test)) {
            const rederTestList = ["labelStickerJP", "characteristicChracterJP", "loveCharacterJP", "loveWarningJP", "meGuideJP",];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
