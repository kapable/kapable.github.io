...
class Result extends Component {
    ...
    otherTestBannerRenderer() {
        ...
        let speechHabitJPList = ["speechHabitJP"];
        ...
        let colorLabelStickerEngList = ["colorLabelStickerEng"];
        let mazeHeartList = ["mazeHeart"];
        ...
        if(personalColor2022ListKor.includes(this.state.current_test)){
            ...
            const rederTestList = ["colorLabelStickerEng", "labelStickerEng", "DIYEng", "earthCharacteristicEng", "puzzleLoveEng",];
            return(
                <Fragment>
        ...
        } else if (colorLabelStickerEngList.includes(this.state.current_test)) {
            const rederTestList = ["DIYEng", "labelStickerEng", "earthCharacteristicEng", "puzzleLoveEng",];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
        ...
        } else if (mazeHeartList.includes(this.state.current_test)) {
            const rederTestList = ["loveRecipe", "lettering", "tapeCharacteristic", "postCard", "puzzleLove", "labelSticker",];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
            ...
            const rederTestList = ["speechHabitJP", "loveFlameJP", "readyToBoneJP", "earthCharacteristicJP", "cantWaitJP", "puzzleLoveJP",];
            return(
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
        ...
        } else if (speechHabitJPList.includes(this.state.current_test)) {
            const rederTestList = ["loveFlameJP", "readyToBoneJP", "earthCharacteristicJP", "cantWaitJP", "puzzleLoveJP", "coupleCharacterJP", "loveCellJP",];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
            ...
            const rederTestList = ["mazeHeart", "loveRecipe", "lettering", "puzzleLove", "labelSticker",];
            return(
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
