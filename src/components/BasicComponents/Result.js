...
class Result extends Component {
    ...
    otherTestBannerRenderer() {
        ...
        let JPTestList = ["loveTicketJP", "loveCharacterMaleJP", "loveCharacterFemaleJP", "loveWarningJP", "meGuideJP", "smileColorTestJP", "flowerBTIJP", "auditionBTIJp", "percentageMBTI2022JP", "oneSidedLoveJP", "dringkingHabitJP", "personalColorJP"];
        ...
        let polaroidCharacteristicJPList = ["polaroidCharacteristicJP"];
        ...
        let polaroidCharacteristicEngList = ["polaroidCharacteristicEng"];
        let earthCharacteristicList = ["earthCharacteristic"];
        let hmallList = ['hmall'];
        if(personalColor2022ListKor.includes(this.state.current_test)){
            ...
            const rederTestList = ["polaroidCharacteristicEng", "loveTicketEng", "labelStickerLoveEng", "emotionGraphEng", "labelStickerEng",];
            return(
                <Fragment>
        ...
        } else if (polaroidCharacteristicEngList.includes(this.state.current_test)) {
            const rederTestList = ["loveTicketEng", "labelStickerLoveEng", "emotionGraphEng", "labelStickerEng", "loveMagazineEng",];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
        ...
        } else if (earthCharacteristicList.includes(this.state.current_test)) {
            const rederTestList = ["polaroidCharacteristic", "loveTicket", "labelStickerFriendship", "labelStickerLove", "labelSticker", "cloudLove", "loveMagazine", "emotionGraph",];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
            ...
            const rederTestList = ["polaroidCharacteristicJP", "loveTicketJP", "labelStickerJP", "characteristicChracterJP", "loveCharacterJP", "loveWarningJP", "meGuideJP", "smileColorTestJP",];
            return(
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
        ...
        } else if (polaroidCharacteristicJPList.includes(this.state.current_test)) {
            const rederTestList = ["loveTicketJP", "labelStickerJP", "characteristicChracterJP", "loveCharacterJP", "loveWarningJP", "meGuideJP",];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
            ...
            const rederTestList = ["earthCharacteristic", "polaroidCharacteristic", "loveTicket", "labelStickerFriendship", "labelStickerLove", "labelSticker", "cloudLove", "emotionGraph",];
            return(
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
