...
class Result extends Component {
    ...
    otherTestBannerRenderer() {
        ...
        let CNTestList = ["loveCellCN", "speechHabitCN", "bondeeCN", "loveFlameCN", "characteristicChracterCN", "loveWarningCN", "loveCharacterCN", "smileColorTestCn", "auditionBTICn", "percentageMBTI2022Cn", "personalColor2022CN", "oneSidedLoveCN"];
        ...
        let coupleCharacterCNList = ["coupleCharacterCN", "coupleCharacterMaleCN", "coupleCharacterFemaleCN"];
        ...
        if(personalColor2022ListKor.includes(this.state.current_test)){
            ...
            const rederTestList = ["coupleCharacterCN", "loveCharacterCN", "speechHabitCN", "smileColorTestCn", "loveCellCN"];
            return(
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
        ...
        } else if (coupleCharacterCNList.includes(this.state.current_test)) {
