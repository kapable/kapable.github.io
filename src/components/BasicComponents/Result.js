...
class Result extends Component {
    ...
    otherTestBannerRenderer() {
        ...
        if(personalColor2022ListKor.includes(this.state.current_test)){
            ...
            const rederTestList = ["mailForMeEng", "characteristicChracterEng", "loveWarningEng", "meGuideEng", "loveCharacterEng", "memoEng", "smileColorTestEng"];
            return(
                <Fragment>
        ...
        } else if (mailForMeEngList.includes(this.state.current_test)) {
            const rederTestList = ["characteristicChracterEng", "loveWarningEng", "meGuideEng", "loveCharacterEng", "smileColorTestEng", "memoEng"];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
