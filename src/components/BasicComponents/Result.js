...
class Result extends Component {
    ...
    otherTestBannerRenderer() {
        ...
        let loveSpeedEngList = ["loveSpeedEng"];
        ...
        if(personalColor2022ListKor.includes(this.state.current_test)){
            ...
            const rederTestList = ["loveSpeedEng", "loveCellEng", "speechHabitEng", "mbtiFeaturesEng", "bondeeEng", "loveFlameEng",];
            return(
                <Fragment>
        ...
        } else if (loveSpeedEngList.includes(this.state.current_test)) {
            const rederTestList = ["loveCellEng", "speechHabitEng", "mbtiFeaturesEng", "bondeeEng", "loveFlameEng", "readyToBoneEng", "mailForMeEng", "characteristicChracterEng", "loveWarningEng",];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
