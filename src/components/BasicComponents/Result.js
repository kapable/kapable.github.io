...
class Result extends Component {
    ...
    otherTestBannerRenderer() {
        ...
        } else if (loveCellJPList.includes(this.state.current_test)) {
            const rederTestList = ["loveSpringFlowerJP", "mbtiFeaturesJP", "emotionGraphJP", "polaroidCharacteristicJP",];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
