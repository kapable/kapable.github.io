...
class Result extends Component {
    ...
    otherTestBannerRenderer() {
        ...
        let CNTestList = ["coupleCharacterMaleCN", "coupleCharacterFemaleCN", "loveCellCN", "speechHabitCN", "bondeeCN", "loveFlameCN", "characteristicChracterCN", "loveWarningCN", "loveCharacterCN", "smileColorTestCn", "auditionBTICn", "percentageMBTI2022Cn", "personalColor2022CN", "oneSidedLoveCN"];
        ...
        let loveSpringFlowerCNList = ["loveSpringFlowerCN"];
        ...
        if(personalColor2022ListKor.includes(this.state.current_test)){
            ...
            const rederTestList = ["loveSpringFlowerCN", "coupleCharacterCN", "loveCharacterCN", "speechHabitCN", "smileColorTestCn", "loveCellCN"];
            return(
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
        ...
        } else if (loveSpringFlowerCNList.includes(this.state.current_test)) {
            const rederTestList = ["coupleCharacterCN", "speechHabitCN", "bondeeCN", "loveFlameCN", "readyToBoneCN", "mailForMeCN", "characteristicChracterCN",];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
