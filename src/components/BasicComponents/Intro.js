...
class Intro extends Component {
    ...
    componentDidMount(){
        ...
        let dualQueries = ["factPok", "MyFactPok", "FriendFactPok", "loveCharacter", "loveCharacterFemale", "loveCharacterMale", "loveCharacterEng", "loveCharacterFemaleEng", "loveCharacterMaleEng"];
