...
class Result extends Component {
    ...
    otherTestBannerRenderer() {
        ...
        let scrapBookCharJPList = ["scrapBookCharJP"];
        ...
        let rainDropEngList = ["rainDropEng"];
        let alienCharList = ["alienChar"];
        ...
        if(personalColor2022ListKor.includes(this.state.current_test)){
            ...
            const rederTestList = ["rainDropEng", "digitalCharEng", "postCardEng", "mazeHeartEng", "colorLabelStickerEng",];
            return(
                <Fragment>
        ...
        } else if (rainDropEngList.includes(this.state.current_test)) {
            const rederTestList = ["digitalCharEng", "postCardEng", "mazeHeartEng", "colorLabelStickerEng", "DIYEng", "labelStickerEng",];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
        ...
        } else if (alienCharList.includes(this.state.current_test)) {
            const rederTestList = ["playlist", "loveTV", "loveStyle", "charRoad", "whyLove", "charPyramid",];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
            ...
            const rederTestList = ["scrapBookCharJP", "hologramLoveJP", "rainDropJP", "flowerGardenJP",];
            return(
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
        ...
        } else if (scrapBookCharJPList.includes(this.state.current_test)) {
            const rederTestList = ["hologramLoveJP", "rainDropJP", "flowerGardenJP", "speechHabitJP", "loveFlameJP",];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
            ...
            const rederTestList = ["alienChar", "playlist", "loveTV", "loveStyle", "charRoad", "whyLove", "charPyramid",];
            return(
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
