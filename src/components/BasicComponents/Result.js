...
class Result extends Component {
    ...
    otherTestBannerRenderer() {
        ...
        let loveTicketEngList = ["loveTicketEng"];
        ...
        if(personalColor2022ListKor.includes(this.state.current_test)){
            ...
            const rederTestList = ["loveTicketEng", "labelStickerLoveEng", "emotionGraphEng", "labelStickerEng",];
            return(
                <Fragment>
        ...
        } else if (loveTicketEngList.includes(this.state.current_test)) {
            const rederTestList = ["labelStickerLoveEng", "emotionGraphEng", "labelStickerEng", "loveMagazineEng",];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
