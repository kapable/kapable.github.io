...
class Result extends Component {
    ...
    otherTestBannerRenderer() {
        ...
        if(personalColor2022ListKor.includes(this.state.current_test)){
        ...
        } else if (princessList.includes(this.state.current_test)) {
            const rederTestList = ["gypsophila", "mailForMe", "todayLuck", "characteristicChracter", "loveWarning", "meGuide"];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
            ...
            const rederTestList = ["princess", "gypsophila", "diet", "mailForMe", "todayLuck", "hamster", "characteristicChracter", "loveWarning", "meGuide"];
            return(
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
