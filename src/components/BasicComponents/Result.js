...
class Result extends Component {
    ...
    otherTestBannerRenderer() {
        ...
        let puffyCloudsList = ["puffyClouds"];
        ...
        if(personalColor2022ListKor.includes(this.state.current_test)){
        ...
        } else if (puffyCloudsList.includes(this.state.current_test)) {
            ...
            const rederTestList = ["puffyClouds", "guestbookChar", "bookChar", "newsChar", "zgChar",];
            return(
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
