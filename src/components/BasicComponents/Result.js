...
class Result extends Component {
    ...
    otherTestBannerRenderer() {
        ...
        let gradationCharList = ["gradationChar"];
        ...
        if(personalColor2022ListKor.includes(this.state.current_test)){
        ...
        } else if (gradationCharList.includes(this.state.current_test)) {
            const rederTestList = ["magazineTheme", "colorFiveTheme", "fifteenTheme", "ingredientChar", "watercolorChar", "batteryChar", "rainbowNote",];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
            ...
            const rederTestList = ["magazineTheme", "colorFiveTheme", "fifteenTheme", "gradationChar", "ingredientChar", "watercolorChar", "batteryChar",];
            return(
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
