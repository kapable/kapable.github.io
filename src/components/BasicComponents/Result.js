...
class Result extends Component {
    ...
    otherTestBannerRenderer() {
        ...
        if(personalColor2022ListKor.includes(this.state.current_test)){
        ...
        } else if (glitchCharList.includes(this.state.current_test)) {
            const rederTestList = ["magazineTheme", "colorFiveTheme", "fifteenTheme", "myHeart18", "warmCoolColorcode", "findHiddenChar", "wishPlease",];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
            ...
            const rederTestList = ["magazineTheme", "colorFiveTheme", "fifteenTheme", "glitchChar", "myHeart18", "warmCoolColorcode", "findHiddenChar",];
            return(
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
