...
class Result extends Component {
    ...
    otherTestBannerRenderer() {
        ...
        let loveSpicyEngList = ["loveSpicyEng"];
        ...
        if(personalColor2022ListKor.includes(this.state.current_test)){
            ...
            const rederTestList = ["loveSpicyEng", "cantWaitEng", "loveSpringFlowerEng", "coupleCharacterEng", "loveSpeedEng", "loveCellEng", "speechHabitEng"];
            return(
                <Fragment>
        ...
        } else if (loveSpicyEngList.includes(this.state.current_test)) {
            const rederTestList = ["cantWaitEng", "loveSpringFlowerEng", "coupleCharacterEng", "loveSpeedEng", "loveCellEng", "speechHabitEng", "mbtiFeaturesEng"];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
