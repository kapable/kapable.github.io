    ...
    <>
      ...
      <BarsDiv>
        <LeftBars className='pct-mbti-left-bar'>
          <div className='pct-mbti-left-e'>
            <p>{scoreE * 20}%</p>
          </div>
          <div className='pct-mbti-left-s'>
            <p>{scoreS * 20}%</p>
          </div>
          <div className='pct-mbti-left-t'>
            <p>{scoreT * 20}%</p>
          </div>
          <div className='pct-mbti-left-p'>
            <p>{scoreP * 20}%</p>
          </div>
        </LeftBars>
        <RightBar className='pct-mbti-right-bar'>
          <div className='pct-mbti-right-i'>
            <p>{scoreI * 20}%</p>
          </div>
          <div className='pct-mbti-right-n'>
            <p>{scoreN * 20}%</p>
          </div>
          <div className='pct-mbti-right-f'>
            <p>{scoreF * 20}%</p>
          </div>
          <div className='pct-mbti-right-j'>
            <p>{scoreJ * 20}%</p>
          </div>
        </RightBar>
      </BarsDiv>
