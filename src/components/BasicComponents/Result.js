...
class Result extends Component {
    ...
    otherTestBannerRenderer() {
        ...
        if(personalColor2022ListKor.includes(this.state.current_test)){
            ...
            const rederTestList = ["bondeeEng", "loveFlameEng", "readyToBoneEng", "mailForMeEng", "characteristicChracterEng", "loveWarningEng",];
            return(
                <Fragment>
        ...
        } else if (bondeeEngList.includes(this.state.current_test)) {
            const rederTestList = ["loveFlameEng", "readyToBoneEng", "mailForMeEng", "characteristicChracterEng", "loveWarningEng",];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
        ...
        } else if (mzScoreList.includes(this.state.current_test)) {
        ...
        } else if (bondeeCNList.includes(this.state.current_test)) {
            const rederTestList = ["loveFlameCN", "readyToBoneCN", "mailForMeCN", "characteristicChracterCN", "loveWarningCN", "loveCharacterCN", "smileColorTestCn",];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
            ...
            const rederTestList = ["mzScore", "lifetimeSaju", "mbtiFeatures", "bondee", "loveFlame", "quokka", "travelCarrier", "readyToBone",];
            return(
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
