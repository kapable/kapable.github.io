...
class Result extends Component {
    ...
    otherTestBannerRenderer() {
        ...
        if(personalColor2022ListKor.includes(this.state.current_test)){
        ...
        } else if (naileageList.includes(this.state.current_test)) {
            const rederTestList = ["colorFiveTheme", "fifteenTheme", "weekendSchedule", "youAndI", "blogChar", "catoonChar",];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
            ...
            const rederTestList = ["colorFiveTheme", "fifteenTheme", "naileage", "weekendSchedule", "youAndI", "blogChar", ];
            return(
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
