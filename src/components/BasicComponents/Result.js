...
class Result extends Component {
    ...
    otherTestBannerRenderer() {
        ...
        let earthCharacteristicJPList = ["earthCharacteristicJP"];
        ...
        } else if (earthCharacteristicJPList.includes(this.state.current_test)) {
            const rederTestList = ["cantWaitJP", "puzzleLoveJP", "coupleCharacterJP", "loveCellJP",];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
