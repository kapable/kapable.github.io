...
class Result extends Component {
    ...
    otherTestBannerRenderer() {
        ...
        if(personalColor2022ListKor.includes(this.state.current_test)){
        ...
        } else if (colorPenList.includes(this.state.current_test)) {
            const rederTestList = ["colorFiveTheme", "colorSquare", "fifteenTheme", "colorChart", "naileage", "weekendSchedule", ];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
            ...
            const rederTestList = ["colorFiveTheme", "fifteenTheme", "colorPen", "colorSquare", "colorChart", "naileage", "weekendSchedule", ];
            return(
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
