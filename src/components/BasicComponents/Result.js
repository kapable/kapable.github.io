...
class Result extends Component {
    ...
    otherTestBannerRenderer() {
        ...
        if(personalColor2022ListKor.includes(this.state.current_test)){
        ...
        } else if (blockYouList.includes(this.state.current_test)) {
            const rederTestList = ["keyboardChar", "knitting", "colorWoodstick", "charFile", "koreanTable", "colorScream",];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
            ...
            const rederTestList = ["blockYou", "keyboardChar", "knitting", "colorWoodstick", "charFile", "koreanTable", "colorScream",];
            return(
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
