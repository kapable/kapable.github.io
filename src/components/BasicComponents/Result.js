...
class Result extends Component {
    ...
    otherTestBannerRenderer() {
        ...
        if(personalColor2022ListKor.includes(this.state.current_test)){
            ...
            const rederTestList = ["loveCellEng", "speechHabitEng", "mbtiFeaturesEng", "bondeeEng", "loveFlameEng",];
            return(
                <Fragment>
        ...
        } else if (loveCellEngList.includes(this.state.current_test)) {
            const rederTestList = ["speechHabitEng", "mbtiFeaturesEng", "bondeeEng", "loveFlameEng", "readyToBoneEng", "mailForMeEng", "characteristicChracterEng", "loveWarningEng",];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
        ...
        } else if (shootingStarList.includes(this.state.current_test)) {
            const rederTestList = ["chatGPTCharacteristic", "lifeInterpreting", "thatDiary", "newYearSemester", "speechHabit", "mzScore", "lifetimeSaju", "bondee",];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
            ...
            const rederTestList = ["loveCellCN", "speechHabitCN", "bondeeCN", "loveFlameCN", "readyToBoneCN", "mailForMeCN", "characteristicChracterCN", "loveWarningCN",];
            return(
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
        ...
        } else if (loveCellCNList.includes(this.state.current_test)) {
            const rederTestList = ["speechHabitCN", "bondeeCN", "loveFlameCN", "readyToBoneCN", "mailForMeCN", "characteristicChracterCN",];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
            ...
            const rederTestList = ["shootingStar", "chatGPTCharacteristic", "lifeInterpreting", "loveCell", "thatDiary", "newYearSemester", "speechHabit", "mzScore", "lifetimeSaju",];
            return(
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
