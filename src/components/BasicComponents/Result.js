...
class Result extends Component {
    ...
    otherTestBannerRenderer() {
        ...
        let checkMeSimpleList = ["checkMeSimple"];
        ...
        if(personalColor2022ListKor.includes(this.state.current_test)){
        ...
        } else if (checkMeSimpleList.includes(this.state.current_test)) {
            const rederTestList = ["colorFiveTheme", "fifteenTheme", "askChar", "Y2KText", "agriGameChar", "dailyChar",];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
            ...
            const rederTestList = ["colorFiveTheme", "fifteenTheme", "checkMeSimple", "askChar", "Y2KText", "agriGameChar",];
            return(
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
