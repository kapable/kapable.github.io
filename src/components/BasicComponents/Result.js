...
class Result extends Component {
    ...
    otherTestBannerRenderer() {
        ...
        let remindProfileList = ["remindProfile"];
        ...
        if(personalColor2022ListKor.includes(this.state.current_test)){
        ...
        } else if (remindProfileList.includes(this.state.current_test)) {
            ...
            const rederTestList = ["remindProfile", "iPhoneMemo", "egoProfile", "colorPalette", "tanghulu",];
            return(
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
