...
class Result extends Component {
    ...
    otherTestBannerRenderer() {
        ...
        let loveSpringFlowerJPList = ["loveSpringFlowerJP"];
        ...
        if(personalColor2022ListKor.includes(this.state.current_test)){
            ...
            const rederTestList = ["loveSpringFlowerJP", "mbtiFeaturesJP", "emotionGraphJP", "polaroidCharacteristicJP", "loveTicketJP", "labelStickerJP",];
            return(
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
        ...
        } else if (loveSpringFlowerJPList.includes(this.state.current_test)) {
            const rederTestList = ["mbtiFeaturesJP", "emotionGraphJP", "polaroidCharacteristicJP", "loveTicketJP", "labelStickerJP",];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
