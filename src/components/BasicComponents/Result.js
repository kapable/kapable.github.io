...
class Result extends Component {
    ...
    otherTestBannerRenderer() {
        ...
        } else if (loveWarningESList.includes(this.state.current_test)) {
            const rederTestList = ["loveWarningES"];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
