...
class Result extends Component {
    ...
    otherTestBannerRenderer() {
        ...
        let CNTestList = ["characteristicChracterCN", "loveWarningCN", "loveCharacterCN", "smileColorTestCn", "auditionBTICn", "percentageMBTI2022Cn", "personalColor2022CN", "oneSidedLoveCN"];
        ...
        let loveFlameCNList = ["loveFlameCN"];
        ...
        if(personalColor2022ListKor.includes(this.state.current_test)){
            ...
            const rederTestList = ["readyToBoneEng", "mailForMeEng", "characteristicChracterEng", "loveWarningEng", "meGuideEng", "loveCharacterEng",];
            return(
                <Fragment>
        ...
        } else if (readyToBoneEngList.includes(this.state.current_test)) {
            const rederTestList = ["mailForMeEng", "characteristicChracterEng", "loveWarningEng", "meGuideEng", "loveCharacterEng",];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
        ...
        } else if (bondeeList.includes(this.state.current_test)) {
        ...
        } else if (loveFlameCNList.includes(this.state.current_test)) {
            const rederTestList = ["readyToBoneCN", "mailForMeCN", "characteristicChracterCN", "loveWarningCN", "loveCharacterCN", "smileColorTestCn",];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
