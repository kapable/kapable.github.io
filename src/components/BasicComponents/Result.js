...
class Result extends Component {
    ...
    otherTestBannerRenderer() {
        ...
        let rainbowNoteList = ["rainbowNote"];
        ...
        if(personalColor2022ListKor.includes(this.state.current_test)){
        ...
        } else if (rainbowNoteList.includes(this.state.current_test)) {
            const rederTestList = ["magazineTheme", "colorFiveTheme", "fifteenTheme", "popupSketch", "balloonDart", "angerExplosion",];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
            ...
            const rederTestList = ["magazineTheme", "colorFiveTheme", "fifteenTheme", "rainbowNote", "popupSketch", "balloonDart", ];
            return(
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
