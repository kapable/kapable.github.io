...
class Result extends Component {
    ...
    otherTestBannerRenderer() {
        ...
        let CNTestList = ["loveWarningCN", "loveCharacterCN", "smileColorTestCn", "auditionBTICn", "percentageMBTI2022Cn", "personalColor2022CN", "oneSidedLoveCN"];
        ...
        let characteristicChracterCNList = ["characteristicChracterCN"];
        ...
        if(personalColor2022ListKor.includes(this.state.current_test)){
            ...
            const rederTestList = ["characteristicChracterEng", "loveWarningEng", "meGuideEng", "loveCharacterEng", "memoEng", "waterLoveEng", "musicNoteEng", "fishShapedBunEng", "smileColorTestEng", "snowflakeEng", "flowerBTIEng", "oneSidedLoveEng"];
            return(
                <Fragment>
        ...
        } else if (characteristicChracterEngList.includes(this.state.current_test)) {
            const rederTestList = ["loveWarningEng", "meGuideEng", "loveCharacterEng", "smileColorTestEng", "memoEng", "waterLoveEng", "musicNoteEng", "fishShapedBunEng", "snowflakeEng", "flowerBTIEng", "personalColor2022Eng"];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
        ...
        } else if (gypsophilaList.includes(this.state.current_test)) {
            ...
            const rederTestList = ["characteristicChracterCN", "loveWarningCN", "loveCharacterCN", "smileColorTestCn", "auditionBTICn", "percentageMBTI2022Cn", "personalColor2022CN", "oneSidedLoveCN"];
            return(
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
        ...
        } else if (characteristicChracterCNList.includes(this.state.current_test)) {
            const rederTestList = ["loveWarningCN", "loveCharacterCN", "smileColorTestCn", "auditionBTICn", "percentageMBTI2022Cn", "personalColor2022CN"];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
            ...
            const rederTestList = ["gypsophila", "diet", "mailForMe", "todayLuck", "hamster", "characteristicChracter", "loveWarning", "meGuide", "loveCharacter",];
            return(
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
