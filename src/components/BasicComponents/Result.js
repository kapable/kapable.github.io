...
class Result extends Component {
    ...
    otherTestBannerRenderer() {
        ...
        let egoProfileJPList = ["egoProfileJP"];
        ...
        if(personalColor2022ListKor.includes(this.state.current_test)){
        ...
        } else if (lovePotionList.includes(this.state.current_test)) {
            const rederTestList = ["puffyClouds", "guestbookChar", "bookChar", "newsChar", "zgChar", "remindProfile", ];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
            ...
            const rederTestList = ["egoProfileJP", "deepOceanOutlawJP", "bloodTransfusionJP", "colorPaletteJP",];
            return(
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
        ...
        } else if (egoProfileJPList.includes(this.state.current_test)) {
            const rederTestList = ["deepOceanOutlawJP", "bloodTransfusionJP", "colorPaletteJP", "unlockMyHeartJP", "bubbleCharJP",];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
            ...
            const rederTestList = ["lovePotion", "puffyClouds", "guestbookChar", "bookChar", "newsChar", "zgChar",];
            return(
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
