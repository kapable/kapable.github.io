...
class Result extends Component {
    ...
    otherTestBannerRenderer() {
        ...
        } else if (webCharList.includes(this.state.current_test)) {
            const rederTestList = ["magazineTheme", "colorFiveTheme", "fifteenTheme", "letYouKnowYou", "guestCheck", "glitchChar",];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
