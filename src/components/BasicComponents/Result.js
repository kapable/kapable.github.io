...
class Result extends Component {
    ...
    otherTestBannerRenderer() {
        ...
        if(personalColor2022ListKor.includes(this.state.current_test)){
        ...
        } else if (tetrisCharList.includes(this.state.current_test)) {
            const rederTestList = ["alienChar", "playlist", "loveTV", "loveStyle",];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
            ...
            const rederTestList = ["tetrisChar", "alienChar", "playlist", "loveTV", "loveStyle",];
            return(
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
