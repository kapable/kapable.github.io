...
class Result extends Component {
    ...
    otherTestBannerRenderer() {
        ...
        let loveProfileList = ["loveProfile"];
        ...
        if(personalColor2022ListKor.includes(this.state.current_test)){
            ...
            const rederTestList = ["mazeHeartEng", "colorLabelStickerEng", "labelStickerEng", "DIYEng", "earthCharacteristicEng", "puzzleLoveEng",];
            return(
                <Fragment>
        ...
        } else if (mazeHeartEngList.includes(this.state.current_test)) {
            const rederTestList = ["colorLabelStickerEng", "DIYEng", "labelStickerEng", "earthCharacteristicEng", "puzzleLoveEng",];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
        ...
        } else if (loveProfileList.includes(this.state.current_test)) {
            const rederTestList = ["mazeHeart", "loveRecipe", "lettering", "tapeCharacteristic", "postCard", "puzzleLove", "labelSticker",];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
            ...
            const rederTestList = ["loveProfile", "mazeHeart", "loveRecipe", "lettering", "puzzleLove", "labelSticker",];
            return(
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
