        ...
        return (
            <Fragment>
                ...
                <div className="intro container">
                    ...
                    {this.state.current_test.info.mainUrl === 'hmall' || this.state.current_test.info.mainUrl === 'labelStickerSKT' || this.state.current_test.info.mainUrl === 'fatecharmtest' ? null : (
                        <AdsenseAdvertiser
