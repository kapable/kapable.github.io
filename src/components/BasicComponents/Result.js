...
class Result extends Component {
    ...
    otherTestBannerRenderer() {
        ...
        let ferrisWheelList = ["ferrisWheel"];
        ...
        if(personalColor2022ListKor.includes(this.state.current_test)){
        ...
        } else if (ferrisWheelList.includes(this.state.current_test)) {
            ...
            const rederTestList = ["charRoadJP", "scrapBookCharJP", "hologramLoveJP", "rainDropJP", "flowerGardenJP",];
            return(
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
        ...
        } else if (charRoadJPList.includes(this.state.current_test)) {
            const rederTestList = ["scrapBookCharJP", "hologramLoveJP", "rainDropJP",];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
            ...
            const rederTestList = ["ferrisWheel", "tetrisChar", "alienChar", "playlist", "loveTV", "loveStyle",];
            return(
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
