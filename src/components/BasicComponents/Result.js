...
class Result extends Component {
    ...
    otherTestBannerRenderer() {
        ...
        let EngTestList = ["mbtiFeaturesEng", "bondeeEng", "loveWarningEng", "characteristicChracterEng", "meGuideEng", "loveCharacterEng", "loveCharacterFemaleEng", "loveCharacterMaleEng", "memoEng", "waterLoveEng", "musicNoteEng", "fishShapedBunEng", "smileColorTestEng", "personalColorEng", "snowflakeEng", "personalColor2022Eng", "auditionBTIEng", "percentageMBTI2022Eng", "lovejewerlyEng", "idealTypeEng", "fruitAltEng", "facialExpressionAnalyzerEng", "dogSoundsEng", "hanbokBTIEng", "personalColorFactEng", "dringkingHabitEng", "personalIncenseEng"];
        let CNTestList = ["bondeeCN", "loveFlameCN", "characteristicChracterCN", "loveWarningCN", "loveCharacterCN", "smileColorTestCn", "auditionBTICn", "percentageMBTI2022Cn", "personalColor2022CN", "oneSidedLoveCN"];
        let JPTestList = ["loveCharacterMaleJP", "loveCharacterFemaleJP", "loveWarningJP", "meGuideJP", "smileColorTestJP", "flowerBTIJP", "auditionBTIJp", "percentageMBTI2022JP", "oneSidedLoveJP", "dringkingHabitJP"];
        ...
        let speechHabitCNList = ["speechHabitCN"];
        ...
        let speechHabitEngList = ["speechHabitEng"];
        let loveCharacterList = ["loveCharacter", "loveCharacterFemale", "loveCharacterMale"];
        let chatGPTCharacteristicList = ["chatGPTCharacteristic"];
        if(personalColor2022ListKor.includes(this.state.current_test)){
            ...
            const rederTestList = ["speechHabitEng", "mbtiFeaturesEng", "bondeeEng", "loveFlameEng", "readyToBoneEng", "mailForMeEng",];
            return(
                <Fragment>
        ...
        } else if (speechHabitEngList.includes(this.state.current_test)) {
            const rederTestList = ["mbtiFeaturesEng", "bondeeEng", "loveFlameEng", "readyToBoneEng", "mailForMeEng", "characteristicChracterEng", "loveWarningEng",];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
        ...
        } else if (chatGPTCharacteristicList.includes(this.state.current_test)) {
            const rederTestList = ["lifeInterpreting", "thatDiary", "newYearSemester", "speechHabit", "mzScore", "lifetimeSaju", "bondee",];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
            ...
            const rederTestList = ["speechHabitCN", "bondeeCN", "loveFlameCN", "readyToBoneCN", "mailForMeCN", "characteristicChracterCN", "loveWarningCN",];
            return(
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
            ...
            const rederTestList = ["characteristicChracterJP", "loveCharacterJP", "loveWarningJP", "meGuideJP", "smileColorTestJP",];
            return(
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
        ...
        } else if (speechHabitCNList.includes(this.state.current_test)) {
            const rederTestList = ["bondeeCN", "loveFlameCN", "readyToBoneCN", "mailForMeCN", "characteristicChracterCN", "loveWarningCN", "loveCharacterCN", "smileColorTestCn",];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
            ...
            const rederTestList = ["loveCharacterJP", "loveWarningJP", "meGuideJP", "smileColorTestJP", "flowerBTIJP", "auditionBTIJp",];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
            ...
            const rederTestList = ["chatGPTCharacteristic", "lifeInterpreting", "loveCell", "thatDiary", "newYearSemester", "speechHabit", "mzScore", "lifetimeSaju",];
            return(
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
