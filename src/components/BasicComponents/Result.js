...
class Result extends Component {
    ...
    otherTestBannerRenderer() {
        ...
        if(personalColor2022ListKor.includes(this.state.current_test)){
            ...
            const rederTestList = ["loveMagazineEng", "loveInMyHeadEng", "loveSpicyEng", "cantWaitEng", "loveSpringFlowerEng", "coupleCharacterEng",];
            return(
                <Fragment>
        ...
        } else if (loveMagazineEngList.includes(this.state.current_test)) {
            const rederTestList = ["loveInMyHeadEng", "loveSpicyEng", "cantWaitEng", "loveSpringFlowerEng", "coupleCharacterEng", "loveSpeedEng", "loveCellEng", "speechHabitEng", "mbtiFeaturesEng"];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
