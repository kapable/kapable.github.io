...
class Result extends Component {
    ...
    otherTestBannerRenderer() {
        ...
        let readyToBoneJPList = ["readyToBoneJP"];
        ...
        } else if (readyToBoneJPList.includes(this.state.current_test)) {
            const rederTestList = ["earthCharacteristicJP", "cantWaitJP", "puzzleLoveJP", "coupleCharacterJP", "loveCellJP",];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
