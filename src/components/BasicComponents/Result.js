...
class Result extends Component {
    ...
    otherTestBannerRenderer() {
        ...
        let colorPaletteJPList = ["colorPaletteJP"];
        ...
        let colorPaletteEngList = ["colorPaletteEng"];
        let iPhoneMemoList = ["iPhoneMemo"];
        ...
        if(personalColor2022ListKor.includes(this.state.current_test)){
            ...
            const rederTestList = ["colorPaletteEng", "bubbleCharEng", "alienCharEng", "loveLotteryEng",];
            return(
                <Fragment>
        ...
        } else if (colorPaletteEngList.includes(this.state.current_test)) {
        ...
        } else if (iPhoneMemoList.includes(this.state.current_test)) {
            const rederTestList = ["egoProfile", "colorPalette", "tanghulu", "bloodTransfusion", "unlockMyHeart",];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
            ...
            const rederTestList = ["colorPaletteJP", "unlockMyHeartJP", "loveTVJP", "bubbleCharJP", "alienCharJP",];
            return(
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
        ...
        } else if (colorPaletteJPList.includes(this.state.current_test)) {
            const rederTestList = ["unlockMyHeartJP", "bubbleCharJP", "alienCharJP", "whyLoveJP", "charRoadJP",];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
            ...
            const rederTestList = ["iPhoneMemo", "egoProfile", "colorPalette", "tanghulu", "bloodTransfusion",];
            return(
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
