...
class Result extends Component {
    ...
    otherTestBannerRenderer() {
        ...
        if(personalColor2022ListKor.includes(this.state.current_test)){
        ...
        } else if (loveTicketList.includes(this.state.current_test)) {
            const rederTestList = ["labelStickerFriendship", "labelStickerLove", "labelSticker", "cloudLove", "loveMagazine", "emotionGraph",];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
            ...
            const rederTestList = ["loveTicket", "labelStickerFriendship", "labelStickerLove", "labelSticker", "cloudLove", "emotionGraph",];
            return(
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
