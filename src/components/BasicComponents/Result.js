...
class Result extends Component {
    ...
    otherTestBannerRenderer() {
        ...
        if(personalColor2022ListKor.includes(this.state.current_test)){
            ...
            const rederTestList = ["labelStickerEng", "loveMagazineEng", "loveInMyHeadEng", "loveSpicyEng", "cantWaitEng", "loveSpringFlowerEng", "coupleCharacterEng",];
            return(
                <Fragment>
        ...
        } else if (labelStickerEngList.includes(this.state.current_test)) {
            const rederTestList = ["loveMagazineEng", "loveInMyHeadEng", "loveSpicyEng", "cantWaitEng", "loveSpringFlowerEng", "coupleCharacterEng", "loveSpeedEng",];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
