...
class Result extends Component {
    ...
    otherTestBannerRenderer() {
        ...
        } else if (loveTVEngList.includes(this.state.current_test)) {
            const rederTestList = ["rainDropEng", "digitalCharEng", "postCardEng", "mazeHeartEng",];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
