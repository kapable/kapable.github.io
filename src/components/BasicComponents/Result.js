...
class Result extends Component {
    ...
    otherTestBannerRenderer() {
        ...
        let loveFlameEngList = ["loveFlameEng"];
        ...
        if(personalColor2022ListKor.includes(this.state.current_test)){
            ...
            const rederTestList = ["loveFlameEng", "readyToBoneEng", "mailForMeEng", "characteristicChracterEng", "loveWarningEng", "meGuideEng", "loveCharacterEng",];
            return(
                <Fragment>
        ...
        } else if (loveFlameEngList.includes(this.state.current_test)) {
