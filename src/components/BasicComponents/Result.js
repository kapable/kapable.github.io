...
class Result extends Component {
    ...
    otherTestBannerRenderer() {
        ...
        let letYouKnowYouList = ["letYouKnowYou"]; 
        ...
        if(personalColor2022ListKor.includes(this.state.current_test)){
        ...
        } else if (letYouKnowYouList.includes(this.state.current_test)) {
            const rederTestList = ["magazineTheme", "colorFiveTheme", "fifteenTheme", "guestCheck", "glitchChar", "myHeart18", "warmCoolColorcode",];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
            ...
            const rederTestList = ["magazineTheme", "colorFiveTheme", "fifteenTheme", "letYouKnowYou", "guestCheck", "glitchChar", "myHeart18",];
            return(
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
