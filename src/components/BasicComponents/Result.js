...
class Result extends Component {
    ...
    otherTestBannerRenderer() {
        ...
        let warmCoolColorcodeList = ["warmCoolColorcode"]; 
        ...
        if(personalColor2022ListKor.includes(this.state.current_test)){
        ...
        } else if (warmCoolColorcodeList.includes(this.state.current_test)) {
            ...
            const rederTestList = ["magazineTheme", "colorFiveTheme", "fifteenTheme", "warmCoolColorcode", "findHiddenChar", "wishPlease",];
            return(
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
