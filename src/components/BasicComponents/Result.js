...
class Result extends Component {
    ...
    otherTestBannerRenderer() {
        ...
        let bloodTransfusionList = ["bloodTransfusion"];
        ...
        if(personalColor2022ListKor.includes(this.state.current_test)){
        ...
        } else if (bloodTransfusionList.includes(this.state.current_test)) {
            const rederTestList = ["unlockMyHeart", "beachChar", "lovePill", "charDegree",];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
            ...
            const rederTestList = ["bloodTransfusion", "unlockMyHeart", "beachChar", "lovePill",];
            return(
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
