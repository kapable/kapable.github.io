...
class Result extends Component {
    ...
    otherTestBannerRenderer() {
        ...
        let highteenStickerList = ["highteenSticker"];
        ...
        if(personalColor2022ListKor.includes(this.state.current_test)){
        ...
        } else if (highteenStickerList.includes(this.state.current_test)) {
            const rederTestList = ["fifteenTheme", "searchResult", "zookeeper", "distributionTable", "correspondence",];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
            ...
            const rederTestList = ["fifteenTheme", "highteenSticker", "searchResult", "zookeeper", "distributionTable",];
            return(
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
