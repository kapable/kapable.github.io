...
class Result extends Component {
    ...
    otherTestBannerRenderer() {
        ...
        let postCardEngList = ["postCardEng"];
        let charPyramidList = ["charPyramid"];
        ...
        if(personalColor2022ListKor.includes(this.state.current_test)){
            ...
            const rederTestList = ["postCardEng", "mazeHeartEng", "colorLabelStickerEng", "labelStickerEng", "DIYEng",];
            return(
                <Fragment>
        ...
        } else if (postCardEngList.includes(this.state.current_test)) {
            const rederTestList = ["mazeHeartEng", "colorLabelStickerEng", "DIYEng", "labelStickerEng",];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
        ...
        } else if (charPyramidList.includes(this.state.current_test)) {
            const rederTestList = ["rainDrop", "digitalChar", "blackboardChar", "scrapBookChar", "expressionChar", "loveLottery",];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
            ...
            const rederTestList = ["charPyramid", "rainDrop", "digitalChar", "blackboardChar", "scrapBookChar",];
            return(
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
