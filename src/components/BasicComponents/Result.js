...
class Result extends Component {
    ...
    otherTestBannerRenderer() {
        ...
        let letteringBeadsList = ["letteringBeads"];
        ...
        } else if (letteringBeadsList.includes(this.state.current_test)) {
            const rederTestList = ["magazineTheme", "colorFiveTheme", "fifteenTheme", "notiLuck", "leaflet", "christmasSleigh", ];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
