...
class Result extends Component {
    ...
    otherTestBannerRenderer() {
        ...
        let cantWaitEngList = ["cantWaitEng"];
        let loveSpicyList = ["loveSpicy"];
        if(personalColor2022ListKor.includes(this.state.current_test)){
            ...
            const rederTestList = ["cantWaitEng", "loveSpringFlowerEng", "coupleCharacterEng", "loveSpeedEng", "loveCellEng", "speechHabitEng"];
            return(
                <Fragment>
        ...
        } else if (cantWaitEngList.includes(this.state.current_test)) {
            const rederTestList = ["loveSpringFlowerEng", "coupleCharacterEng", "loveSpeedEng", "loveCellEng", "speechHabitEng", "mbtiFeaturesEng"];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
        ...
        } else if (loveSpicyList.includes(this.state.current_test)) {
            const rederTestList = ["springPicninc", "onFire", "cantWait", "haGender", "loveCharacter", "meGuide", "paints", "memo", "smileColorTest"];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
            ...
            const rederTestList = ["cantWaitCN", "loveSpringFlowerCN", "coupleCharacterCN", "loveCharacterCN", "speechHabitCN", "smileColorTestCn", "loveCellCN"];
            return(
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
        ...
        } else if (cantWaitCNList.includes(this.state.current_test)) {
            const rederTestList = ["loveSpringFlowerCN", "coupleCharacterCN", "speechHabitCN", "bondeeCN", "loveFlameCN", "readyToBoneCN", "mailForMeCN", "characteristicChracterCN",];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
            ...
            const rederTestList = ["loveSpicy", "springPicninc", "onFire", "cantWait", "haGender", "loveUniversity", "loveSpringFlower", "lifetimeSaju",];
            return(
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
