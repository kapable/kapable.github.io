...
class Result extends Component {
  ...
  introPageRender() {
    ...
    //     <Switch>
    //     <Route
    //       path={current_tests_path}
    //       component={() => <Intro test={this.state.current_test} />}
    //       exact
    //     />
  ...
  foreignAffiliateRenderer(lang) {
    const aliAffiliateLink = this.state.originAdProb
      ? 'https://s.click.aliexpress.com/e/_DlNChMR'
      ...
      if (foreignTest.includes(this.state.current_test)) {
        ...
        return (
          <Fragment>
            ...
            <img
              loading='lazy'
              src={`https://images.ktestone.com/meta/gardenflower/gardenflower-${gardenflower_type_obj[_current_test_result.type]}-banner.jpg`}
              className='result-img'
        ...
        return (
          <Fragment>
            ...
            <img
              loading='lazy'
              src={`https://images.ktestone.com/meta/MALINGOETZ/MALINGOETZ-${MALINGOETZ_type_obj[_current_test_result.type]}-banner.jpg`}
              className='result-img'
