...
class Result extends Component {
    ...
    otherTestBannerRenderer() {
        ...
        let honeycombCharList = ["honeycombChar"]; 
        ...
        if(personalColor2022ListKor.includes(this.state.current_test)){
        ...
        } else if (honeycombCharList.includes(this.state.current_test)) {
            const rederTestList = ["magazineTheme", "colorFiveTheme", "fifteenTheme", "charScore", "graphicDesignChar", "nagForYou", "webChar",];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
            ...
            const rederTestList = ["magazineTheme", "colorFiveTheme", "fifteenTheme", "honeycombChar", "charScore", "graphicDesignChar", "nagForYou",];
            return(
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
