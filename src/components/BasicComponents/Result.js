...
class Result extends Component {
    ...
    otherTestBannerRenderer() {
        ...
        let flowerGardenJPList = ["flowerGardenJP"];
        ...
        if(personalColor2022ListKor.includes(this.state.current_test)){
        ...
        } else if (charRoadList.includes(this.state.current_test)) {
            const rederTestList = ["whyLove", "charPyramid", "rainDrop", "digitalChar", "blackboardChar", "scrapBookChar",];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
            ...
            const rederTestList = ["flowerGardenJP", "speechHabitJP", "loveFlameJP", "readyToBoneJP", "earthCharacteristicJP", "cantWaitJP", "puzzleLoveJP",];
            return(
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
        ...
        } else if (flowerGardenJPList.includes(this.state.current_test)) {
            const rederTestList = ["speechHabitJP", "loveFlameJP", "readyToBoneJP", "earthCharacteristicJP", "cantWaitJP"];
            return (
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
            ...
            const rederTestList = ["charRoad", "whyLove", "charPyramid", "rainDrop", "digitalChar",];
            return(
                <Fragment>
                    {rederTestList.map((test) => (
                        <Fragment key={test + '-test-key'}>
